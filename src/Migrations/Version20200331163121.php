 ...
 */
final class Version20200331163121 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE mission_sensor ADD id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', ADD name VARCHAR(255) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE mission_sensor ADD PRIMARY KEY (id)');
    }
