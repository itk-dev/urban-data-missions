 ...
 */
final class Version20200330125957 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE mission_sensor (mission_id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', sensor_id VARCHAR(255) NOT NULL, INDEX IDX_E47ECDFEBE6CAE90 (mission_id), INDEX IDX_E47ECDFEA247991F (sensor_id), PRIMARY KEY(mission_id, sensor_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
